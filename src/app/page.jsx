      ...
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          ...
          <p className="mt-6 text-xl text-slate-600">
            کارنسا، استودیویی با تمرکز بر خلاقیت و کیفیت در طراحی، مشاوره و توسعه اپلیکیشن‌های وب و موبایل است. تیم ما از افراد متخصص و با تجربه تشکیل شده است و با استفاده از جدیدترین تکنولوژی‌ها و رویکردهای نوآورانه، بهترین راه حل‌های برنامه نویسی را برای مشتریان ارائه می‌دهد. با کارنسا، تجربه‌ی کاری متفاوتی خواهید داشت و به طراحی وبسایت‌هایی منحصر به فرد و کارآمد دست خواهید یافت. ما به ارائه خدمات با کیفیت بالا و رضایت مشتریانمان اهمیت می‌دهیم.
          </p>
        </FadeIn>
      </Container>
